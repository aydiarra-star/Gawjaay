...
const SQL_FILES = ['000_base.sql', '001_lot_a.sql', '002_lot_b.sql', '003_lot_c.sql', '004_lot_d.sql', '005_lot_e.sql', '006_lot_f.sql', '007_prod_indexes.sql', '008_idempotency.sql', '009_v3_categories_indexes.sql'];
